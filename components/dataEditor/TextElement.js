    ...
    renderEdit() {
        return (
            <div className="form-group">
                <label className="col-sm-2 control-label">{this.props.label}</label>
                <div className="col-sm-10">
                    <textarea className="form-control" rows="6" data-minwords="6" data-required="true" onChange={(e)=>this.handleEdit(e)} placeholder={this.props.placeholder} value={this.state.field_value}></textarea>
